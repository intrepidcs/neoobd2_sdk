...
#ifndef _OBD2LC_WIFI_CC32XX_H_
#define _OBD2LC_WIFI_CC32XX_H_
...
extern int MG_RPM_Msg_HS_CAN_Index;
typedef struct {
...
#define MG_RPM_Msg_HS_CAN_ClearStats() \
    CM_GetSetValue(CM_GETSET_TX_STATS_CLR, MG_RPM_Msg_HS_CAN_Index, 0)

extern int MG_Speed_Msg_HS_CAN_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
...
#define MG_Speed_Msg_HS_CAN_ClearStats() \
    CM_GetSetValue(CM_GETSET_TX_STATS_CLR, MG_Speed_Msg_HS_CAN_Index, 0)

extern int MG_Throttle_Msg_HS_CAN_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
} MG_Throttle_Msg_HS_CAN;
...
#define MG_Throttle_Msg_HS_CAN_ClearStats() \
    CM_GetSetValue(CM_GETSET_TX_STATS_CLR, MG_Throttle_Msg_HS_CAN_Index, 0)
