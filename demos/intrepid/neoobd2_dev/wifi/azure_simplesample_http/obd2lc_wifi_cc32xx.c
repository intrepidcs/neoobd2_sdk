...
void CM_MG_Speed_Msg_HS_CAN()
{
    MG_Speed_Msg_HS_CAN stMyStruct;
    MG_Speed_Msg_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_Speed_Msg_HS_CAN(&stMyStruct);
}

void CM_MG_RPM_Msg_HS_CAN()
{
    MG_RPM_Msg_HS_CAN stMyStruct;
    MG_RPM_Msg_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_RPM_Msg_HS_CAN(&stMyStruct);
}

void CM_MG_Throttle_Msg_HS_CAN()
{
    MG_Throttle_Msg_HS_CAN stMyStruct;
    MG_Throttle_Msg_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_Throttle_Msg_HS_CAN(&stMyStruct);
}
...
void CM_ExtensionInit(const struct stCallBackPointers * pCb)
{
    ...
    CM_RegisterCallback(CM_CALLBACKTYPE_MESSAGE_MG, MG_Speed_Msg_HS_CAN_Index,CM_MG_Speed_Msg_HS_CAN);
    CM_RegisterCallback(CM_CALLBACKTYPE_MESSAGE_MG, MG_RPM_Msg_HS_CAN_Index,CM_MG_RPM_Msg_HS_CAN);
    CM_RegisterCallback(CM_CALLBACKTYPE_MESSAGE_MG, MG_Throttle_Msg_HS_CAN_Index,CM_MG_Throttle_Msg_HS_CAN);
}
...
int MG_RPM_Msg_HS_CAN_Index = 0;

void MG_RPM_Msg_HS_CAN_Init(MG_RPM_Msg_HS_CAN * pMsg)
{
    int iActualSignalMaxCount;

    CM_MessageGenericInit(1, 
    MG_RPM_Msg_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
...
int MG_RPM_Msg_HS_CAN_Transmit(MG_RPM_Msg_HS_CAN * pMsg)
{
    return CM_TxFromSignals(1, MG_RPM_Msg_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int MG_RPM_Msg_HS_CAN_Transmit_raw(MG_RPM_Msg_HS_CAN * pMsg)
{
    return CM_TxFromRawSignals(1, MG_RPM_Msg_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int MG_Speed_Msg_HS_CAN_Index = 1;

void MG_Speed_Msg_HS_CAN_Init(MG_Speed_Msg_HS_CAN * pMsg)
{
    int iActualSignalMaxCount;

    CM_MessageGenericInit(1, 
    MG_Speed_Msg_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    NULL, 0, // number of signals when vspy.h was generated
...
int MG_Speed_Msg_HS_CAN_Transmit(MG_Speed_Msg_HS_CAN * pMsg)
{
    return CM_TxFromSignals(1, MG_Speed_Msg_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int MG_Speed_Msg_HS_CAN_Transmit_raw(MG_Speed_Msg_HS_CAN * pMsg)
{
    return CM_TxFromRawSignals(1, MG_Speed_Msg_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int MG_Throttle_Msg_HS_CAN_Index = 2;

void MG_Throttle_Msg_HS_CAN_Init(MG_Throttle_Msg_HS_CAN * pMsg)
{
    int iActualSignalMaxCount;

    CM_MessageGenericInit(1, 
    MG_Throttle_Msg_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    NULL, 0, // number of signals when vspy.h was generated
...
int MG_Throttle_Msg_HS_CAN_Transmit(MG_Throttle_Msg_HS_CAN * pMsg)
{
    return CM_TxFromSignals(1, MG_Throttle_Msg_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int MG_Throttle_Msg_HS_CAN_Transmit_raw(MG_Throttle_Msg_HS_CAN * pMsg)
{
    return CM_TxFromRawSignals(1, MG_Throttle_Msg_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}
