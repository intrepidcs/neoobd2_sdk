...
Intrepid recommends using CrossWorks for ARM from Rowley for BLE development with neoOBD2 PRO. The neoOBD2 SDK provides sample BLE applications in the form of CrossWorks projects. These projects are based on Segger Embedded Studio projects provided by Nordic in their nRF5 SDK.
